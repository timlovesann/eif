          ...
          <div>
            <Form onSubmit={saveDownloadRequest}>
              <FormGroup role="form">            
                  ...
                  <Row><Col>&nbsp;</Col></Row>
                  <Row><Col>Your file should be ready in a minute. Please refresh your page after one minute and you should see a download link under your request.</Col></Row>
                  <Row><Col>&nbsp;</Col></Row>
                  <Row><Col><b>COUNTY LEVEL DOWNLOADS</b> are reserved for EIF Volunteers and financial contributors.</Col></Row>
                  <Row>
                    <Button type="submit" disabled={!readyforSubmit || submitted} className="btn">Generate File</Button>
                  </Row> 
                </FormGroup>
              </Form>               
          </div>
