...
const generateCountyQVFWithHistory = (request_id, qvf, county_name, next) => {
    ...
    const queryStr = 
        "WITH " +
            ...
            "Aug20 AS (SELECT voter_identification_number, election_date, is_absentee_voter FROM " + qvf + "h WHERE election_date = '08/04/2020'), " +
            "Mar20 AS (SELECT voter_identification_number, election_date, is_absentee_voter FROM " + qvf + "h WHERE election_date = '03/10/2020'), " +            
        ...
        "SELECT " +
            ...
            "CASE aug20_vh.\"election_date\"  WHEN '08/04/2020' THEN (CASE aug20_vh.is_absentee_voter WHEN 'Y' THEN 'A' ELSE (CASE aug20_vh.is_absentee_voter WHEN 'N' THEN 'I' ELSE '' END) END) ELSE 'N' END as Voted_in_Aug_2020, " +
            "CASE mar20_vh.\"election_date\"  WHEN '03/10/2020' THEN (CASE mar20_vh.is_absentee_voter WHEN 'Y' THEN 'A' ELSE (CASE mar20_vh.is_absentee_voter WHEN 'N' THEN 'I' ELSE '' END) END) ELSE 'N' END as Voted_in_Mar_2020, " +
        ...
        "LEFT JOIN aug20 aug20_vh ON v.voter_identification_number = aug20_vh.voter_identification_number " +
        "LEFT JOIN mar20 mar20_vh ON v.voter_identification_number = mar20_vh.voter_identification_number " +        
...
module.exports = {
    ...
    generateCountyQVFWithHistory,
    generateJurisdictionQVFWithHistory,
}